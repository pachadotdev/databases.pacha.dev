...
* [SQL Server](https://databases.pacha.dev/dumps/intendo-sqlserver.sql.gz) (269 MB, check the download with the [md5sum](https://databases.pacha.dev/dumps/intendo-sqlserver.sql.gz.md5))
