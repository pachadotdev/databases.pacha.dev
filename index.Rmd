...
testing lots with live databases is quite valuable. With this resource you can benchmark speed, compression, and DDL types. As I can secure funding for this,
I will make the same databases available under different backends (even
...
* [PostgreSQL](https://databases.pacha.dev/dumps/tradestatistics-postgres.sql.gz) (1.8 GB, check the download with the [md5sum](https://databases.pacha.dev/dumps/tradestatistics-postgres.sql.gz.md5))

## Intendo

* [PostgreSQL](https://databases.pacha.dev/dumps/intendo-postgres.sql.gz) (554 MB, check the download with the [md5sum](https://databases.pacha.dev/dumps/intendo-postgres.sql.gz.md5))

## Financial

* [PostgreSQL](https://databases.pacha.dev/dumps/financial-postgres.sql.gz) (13 MB, check the download with the [md5sum](https://databases.pacha.dev/dumps/financial-postgres.sql.gz.md5))
