...
* [PostgreSQL](https://databases.pacha.dev/dumps/intendo-postgres.sql.gz) (166 MB, check the download with the [md5sum](https://databases.pacha.dev/dumps/intendo-postgres.sql.gz.md5))

* [MySQL/MariaDB](https://databases.pacha.dev/dumps/intendo-mysql.sql.gz) (178 MB, check the download with the [md5sum](https://databases.pacha.dev/dumps/intendo-mysql.sql.gz.md5))

* [SQL Server](https://databases.pacha.dev/dumps/intendo-sqlserver.sql.gz) (206 MB, check the download with the [md5sum](https://databases.pacha.dev/dumps/intendo-sqlserver.sql.gz.md5))
...
mysql < intendo-mysql.sql
```

### SQL Server

<!-- BACKUP DATABASE intendo -->
<!-- TO DISK = 'filepath';  -->
...
GO
GRANT ALTER,INSERT ON SCHEMA :: dbo TO teacher
GO
